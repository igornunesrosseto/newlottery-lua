local config = {
    ...
    playItem = {
        itemId = 2471, -- item required to pull lever
        count = 1
    },
    rouletteOptions = {
        rareItemChance_broadcastThreshold = 500,
        ignoredItems = {418,936}, -- if you have tables/counters/other items on the roulette tiles, add them here
    ...
    prizePool = {
        {itemId = 3043, count = {1,10},   chance = 10000}, -- {itemId = itemid, count = {min, max}, chance = chance/10000} 
        {itemId = 3253, count = {1,1},    chance = 9000 }, -- 
        {itemId = 3389, count = {1,1},    chance = 8500 }, -- 
        {itemId = 3284, count = {1,1},    chance = 7500 }, -- 
        {itemId = 3366, count = {1,1},   chance = 6500 }, -- 
        {itemId = 3387, count = {1,1}, chance = 5000 }, -- 
        {itemId = 3365, count = {1,1},    chance = 4000 }, -- 
       
    },
    roulettePositions = { -- hard-coded to 7 positions.
        Position(32331, 32207, 5), 
        Position(32332, 32207, 5),
        Position(32333, 32207, 5),
        Position(32334, 32207, 5), -- position 4 in this list is hard-coded to be the reward location, which is the item given to the player
        Position(32335, 32207, 5),
        Position(32336, 32207, 5),
        Position(32337, 32207, 5),
    }
}
